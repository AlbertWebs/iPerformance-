@extends('layout')
@section('title', isset($meta_title) ? $meta_title : 'Privacy Policy | iPerformance Africa')
@section('content')
<div class="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
    ...
    <div class="legal-prose rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        @else
            <p class="text-slate-600">Privacy policy is being updated. Please check back later.</p>
        @endif
    </div>
</div>
@endsection
